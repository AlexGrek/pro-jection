...
import { CANVAS_H, CANVAS_W, CORNER_COLOR, GRID_CELL } from '../constants'
 ...
 */
export function drawCalibrationGrid(g: Phaser.GameObjects.Graphics): void {
  g.clear()

  // Interior grid.
  g.lineStyle(3, CORNER_COLOR, 0.45)
